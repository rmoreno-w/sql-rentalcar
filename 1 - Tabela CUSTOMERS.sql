CREATE TABLE CUSTOMERS (
    ...
    NAME VAR_CHAR(128) NOT NULL,
    LAST_NAME VAR_CHAR(155) NOT NULL,
    PHONE VAR_CHAR(16) NOT NULL,
    EMAIL VAR_CHAR(32) NOT NULL,
    ADDRESS VAR_CHAR(200) NOT NULL,
    CITY VAR_CHAR(64) NOT NULL,
    STATE VAR_CHAR(2) NOT NULL,
    BIRTH_DATE DATETIME NOT NULL
);

INSERT INTO CUSTOMERS (NAME, LAST_NAME, PHONE, EMAIL, ADDRESS, CITY, STATE, BIRTH_DATE) VALUES 
